...
## Program structure 
Each model & observation there has a seperate file for reading in the data, cause every raw file looks a bit different. For the model data there are always 2 ways: 
