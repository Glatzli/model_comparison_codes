...
1. either read a timeseries at a specific coordinate "_fixed_point" (first the data is extracted, manipulated and then saved as a .nc file for later use): used for timeseries plotting, vertical profiles etc
2. or read the full domain at a specific timestamp "_fixed_time" (much bigger data due to a lot of height levels): used for spatial plots of full domain as temp, VHD (valley heat deficit) etc
