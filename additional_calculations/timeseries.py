...
icon15 = read_icon_model_3D.read_icon_fixed_point_multiple_hours_hexa(day = 15, hours = range(12, 24), lon = 11.4011756,
                                                                      lat = 47.266076, variant = "ICON")
icon16 = read_icon_model_3D.read_icon_fixed_point_multiple_hours_hexa(day = 16, hours = range(00, 13), lon = 11.4011756,
                                                                      lat = 47.266076, variant = "ICON")
